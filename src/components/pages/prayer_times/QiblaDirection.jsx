...
const QiblaDirection = ({ t, heading, qiblaDirection }) => (
  <section className="flex-1 w-full md:w-1/2 p-2 md:px-4 2xl:px-8 text-green-700 dark:text-gray-200 duration-200 animate__animated animate__fadeInRight">
    ...
    <div className="qibla-container grid justify-center w-full p-4 overflow-hidden">
      <div className="compass relative w-full max-w-xs md:max-w-sm rounded-full duration-200 overflow-hidden" style={{ transform: `rotate(${heading === null ? 0 : heading}deg)` }}>
        <img className="w-full object-contain object-center dark:invert duration-300" src={`${import.meta.env.BASE_URL}images/compass-bg.png`} alt="Compass" />
