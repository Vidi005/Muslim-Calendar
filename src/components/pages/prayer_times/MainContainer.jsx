...
class MainContainer extends React.Component {
  ...
  createPrayerTimeInGregorianMonth () {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const formattedStartDate = startDate.toLocaleString(this.props.parentState.selectedLanguage || 'en', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' }).replace(/Minggu/g, 'Ahad')
  ...
  createPrayerTimeInHijriMonth () {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const formattedGregorianDate = gregorianDate.toLocaleString(this.props.parentState.selectedLanguage || 'en', { weekday: hijriMonth === 9 ? 'short' : 'long', day: 'numeric', month: 'long', year: 'numeric' }).replace(/Minggu/g, 'Ahad').replace(/Min/g, 'Ahd')
