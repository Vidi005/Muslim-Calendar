...
class MainContainer extends React.Component {
  ...
  createPrayerTimeInHijriMonth () {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const formattedGregorianDate = gregorianDate.toLocaleString(this.props.parentState.selectedLanguage || 'en', { calendar: 'gregory', weekday: hijriMonth === 9 && this.props.parentState.isPreciseToSeconds ? 'short' : 'long', day: 'numeric', month: 'long', year: 'numeric' }).replace(/Minggu/g, 'Ahad').replace(/Min/g, 'Ahd').replace(/Jumat/g, 'Jum\'at')
