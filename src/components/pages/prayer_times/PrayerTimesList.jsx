            ...
            : (
              <>
                ...
                <div className="prayer-times-list-container-print hidden flex-col items-center flex-nowrap h-[25.9cm] w-[19.5cm] m-[1cm]">
                  ...
                  <h4 className={`${monthType === 0 ? "leading-tight" : ""} text-center text-black`}>{t('coordinates')} ({t('latitude')} {latitude.toFixed(7)}, {t('longitude')} {longitude.toFixed(7)}, {t('elevation')} {elevation.toFixed(1)} m)</h4>
                ...
                <div className="prayer-times-list-container-download hidden">
                  ...
                  <h4 style={{ lineHeight: monthType === 0 ? "1.25pt" : "1.5pt", textAlign: "center", fontFamily: "'Helvetica', 'Arial'", fontSize: "12pt", color: "black" }}>{t('coordinates')} ({t('latitude')} {latitude.toFixed(7)}, {t('longitude')} {longitude.toFixed(7)}, {t('elevation')} {elevation.toFixed(1)} m)</h4>
