...
const LunarEclipseItem = ({ t, selectedLanguage, selectedTimeZone, lunarEclipse }) => {
  ...
  try {
    lunarEclipseDate = lunarEclipse?.penumbralBeginTime?.toLocaleDateString(selectedLanguage || 'en', { calendar: 'gregory', weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: selectedTimeZone }).replace(/Minggu/g, 'Ahad').replace(/Jumat/g, 'Jum\'at')
    penumbralBeginTime = `${lunarEclipse?.penumbralBeginTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')}`
    lunarPartialBeginTime = lunarEclipse?.kind === 'penumbral' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : `${lunarEclipse?.partialBeginTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} (${lunarEclipse?.isPartialBeginVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
    lunarTotalBeginTime = lunarEclipse?.kind !== 'total' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : `${lunarEclipse?.totalBeginTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} (${lunarEclipse?.isTotalBeginVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
    lunarEclipsePeakTime = `${lunarEclipse?.peak?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} ${lunarEclipse?.kind !== 'penumbral' ? `(${lunarEclipse?.isPeakTimeVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})` : ''}`
    lunarTotalEndTime = lunarEclipse?.kind !== 'total' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : `${lunarEclipse?.totalEndTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} (${lunarEclipse?.isTotalEndVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
    lunarPartialEndTime = lunarEclipse?.kind === 'penumbral' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : `${lunarEclipse?.partialEndTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} (${lunarEclipse?.isPartialEndVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
    penumbralEndTime = `${lunarEclipse?.penumbralEndTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')}`
  } catch (error) {
    lunarEclipseDate = t('unsupported_time_format')
  ...
  return (
    <div className="w-full bg-green-50 dark:bg-black p-2 md:px-4 text-base md:text-sm lg:text-base rounded-md md:rounded-lg shadow lg:shadow-md dark:shadow-white/50 overflow-hidden duration-200">
      <h4 className="mb-1 text-center text-base md:text-sm lg:text-base text-green-900 dark:text-white font-bold">{lunarEclipseDate}</h4>
