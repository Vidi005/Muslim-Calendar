...
const LunarEclipseItem = ({ t, selectedLanguage, selectedTimeZone, lunarEclipse }) => {
  ...
  try {
    ...
    penumbralEndTime = `${lunarEclipse?.penumbralEndTime?.toLocaleTimeString(selectedLanguage || 'en', { timeZone: selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit', second: '2-digit' }).replace(/\./g, ':')} (${lunarEclipse?.isPenumbralEndVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
  } catch (error) {
