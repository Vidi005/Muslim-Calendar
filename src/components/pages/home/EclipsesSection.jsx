...
const EclipsesSection = () => (
  <HomePageConsumer>
    {({ t, state }) => {
      ...
      try {
        penumbralBeginTime = `${state.lunarEclipseInfo?.penumbralBeginTime?.toLocaleString(state.selectedLanguage || 'en', { calendar: 'gregory', day: '2-digit', month: '2-digit', year: 'numeric', timeZone: state.selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit' }).replace(/\./g, ':')} (${state.lunarEclipseInfo?.isPenumbralBeginVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`
        ...
        penumbralEndTime = `${state.lunarEclipseInfo?.penumbralEndTime?.toLocaleString(state.selectedLanguage || 'en', { calendar: 'gregory', day: '2-digit', month: '2-digit', year: 'numeric', timeZone: state.selectedTimeZone, timeZoneName: 'short', hour12: false, hourCycle: 'h23', hour: '2-digit', minute: '2-digit' }).replace(/\./g, ':')} (${state.lunarEclipseInfo?.isPenumbralEndVisible ? t('eclipse_visibilities.0') : t('eclipse_visibilities.1')})`        
      } catch (error) {
