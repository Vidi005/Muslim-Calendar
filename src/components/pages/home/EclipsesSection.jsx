...
const EclipsesSection = () => (
  <HomePageConsumer>
    {({ t, state }) => {
      ...
      const partialDuration = lunarEclipseKind === 'Penumbral' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : convertMinutesToTime(state.lunarEclipseInfo?.partialDuration, t('time_suffixes.0'), t('time_suffixes.1'), t('time_suffixes.2'))
      const totalDuration = lunarEclipseKind !== 'Total' ? t(`lunar_eclipse_infos.${en.lunar_eclipse_infos.length - 1}`) : convertMinutesToTime(state.lunarEclipseInfo?.totalDuration, t('time_suffixes.0'), t('time_suffixes.1'), t('time_suffixes.2'))
