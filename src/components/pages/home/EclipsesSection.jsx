...
const EclipsesSection = () => (
  <HomePageConsumer>
    {({ t, state }) => {
      ...
      const partialBeginTime = state.localSolarEclipseInfo?.partialBeginTime?.toLocaleString(state.selectedLanguage || 'en', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: state.selectedTimeZone, hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })
      const partialEndAltitude = `${state.localSolarEclipseInfo?.partialEndAltitude?.toFixed(2)}°`
      const partialEndTime = `${state.localSolarEclipseInfo?.partialEndTime?.toLocaleString(state.selectedLanguage || 'en', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: state.selectedTimeZone, hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
      const peakAltitude = `${state.localSolarEclipseInfo?.peakAltitude?.toFixed(2)}°`
      const solarEclipsePeakTime = `${state.localSolarEclipseInfo?.peakTime?.toLocaleString(state.selectedLanguage || 'en', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: state.selectedTimeZone, hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
      ...
      const totalBeginTime = `${state.localSolarEclipseInfo?.totalBeginTime <= 0 ? t('local_solar_eclipse_infos.12') : state.localSolarEclipseInfo?.totalBeginTime?.toLocaleString(state.selectedLanguage || 'en', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: state.selectedTimeZone, hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
      ...
      const totalEndTime = `${state.localSolarEclipseInfo?.totalEndTime <= 0 ? t('local_solar_eclipse_infos.12') : state.localSolarEclipseInfo?.totalEndTime?.toLocaleString(state.selectedLanguage || 'en', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric', timeZone: state.selectedTimeZone, hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
