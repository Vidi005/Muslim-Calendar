        ...
        {state.isMoonCrescentMapLoading
          ...
          : (
            <React.Fragment>
              ...
              <h5 className="mb-1 text-center text-green-700 dark:text-gray-200 duration-200"><i>{t('conjunction')}</i>: {state.moonCrescentVisibility.conjunction?.toLocaleString(state.selectedLanguage || "en", { day: "2-digit", month: "2-digit", year: "numeric", hourCycle: "h23", hour: "2-digit", minute: "2-digit", timeZoneName: "short", timeZone: state.selectedTimeZone }).replace(/\./g, ':')}, {t('observation_date')} {state.moonCrescentVisibility.observationDate?.toLocaleString(state.selectedLanguage || "en", { day: "2-digit", month: "2-digit", year: "numeric" })}</h5>
