        ...
        {state.isMoonCrescentMapLoading
          ...
          : (
            <React.Fragment>
              ...
              <div className={`grid w-full p-1 md:p-1.5 gap-1 md:gap-2 items-stretch ${en.moon_visibility_criteria[selectedMoonVisibilityCriteria]?.zones.length > 2 ? "grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4" : "grid-cols-2"}`}>
