...
const CACHE_NAME = 'app-cache-v6.7' // Update the version when deploying new builds to clear old caches
...
self.onmessage = event => {
  ...
  if (type === 'createAdjustedIslamicDate') {
    ...
    const result = getMoonCrescentVisibility(observationDate, timeZone, moonVisibilityCriteria, elongationType, altitudeType, observationTime, correctedRefraction, shownTooltip, steps)
