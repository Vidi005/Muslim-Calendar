...
const getSunInfos = (gregorianDate, timeZone, latitude, longitude, elevation, mazhab, lang) => {
  ...
  phaseAngle > 180 ? moonFacingAngle = moonFacingAngle + 180 : moonFacingAngle = moonFacingAngle
  return [
    sunrise?.date?.toLocaleTimeString(lang || 'en', { hourCycle: "h23", hour: "2-digit", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':') || '--:--',
    sunset?.date?.toLocaleTimeString(lang || 'en', { hourCycle: "h23", hour: "2-digit", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':') || '--:--',
    `${sunAltitude.toFixed(2)}°`,
    `${sunAzimuth.toFixed(2)}°`,
    sunRightAscension,
    sunDeclination,
    ...
    `${culmination.date?.toLocaleString(lang || 'en', { calendar: "gregory", hour: "2-digit", hourCycle: "h23", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':')}`,
    `${midnight.date?.toLocaleString(lang || 'en', { calendar: "gregory", hour: "2-digit", hourCycle: "h23", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':')}`,
    `${phaseAngle}° (${moonStatus})`,
    moonAltitude,
    moonAzimuth,
    moonDeclination,
    moonrise?.date?.toLocaleTimeString(lang || 'en', { hourCycle: "h23", hour: "2-digit", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':') || '--:--',
    moonset?.date?.toLocaleTimeString(lang || 'en', { hourCycle: "h23", hour: "2-digit", minute: "2-digit", timeZoneName: "short", timeZone: timeZone })?.replace(/\./gm, ':') || '--:--',
    illuminationPercent,
    culmination.date,
    midnight.date,
